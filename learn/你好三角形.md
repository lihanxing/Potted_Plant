...
float vertices[] = {
    -0.5f, -0.5f, 0.0f,//top_right
     ...
     0.0f,  0.5f, 0.0f//bottom_left
     //if u want here is top_left
};
```
...
我们将顶点着色器的代码暂时硬编码在代码文件顶部的C风格字符串中：
...
![img](file:///C:\Users\meili\AppData\Roaming\Tencent\Users\2645376975\TIM\WinTemp\RichOle\4]VC16){~DJ@$4NJJ0H$ZKS.png)
